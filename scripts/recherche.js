    ...
    $("#suivant").click(function () {
        ...
        switch (x) {
            case "personne":
                ...
                $(".add").click(function () {
                    if ($("#texte-nom").val() == "poti" && $("#texte-prenom").val() == "chats") {
                    ...
                    function stock(donnee, type) {
                        ...
                        if (type == "sortie") {
                            structureb = { "annee": donnee[2], "mois": donnee[1], "jour": donnee[0] };
                        }
                        ...
                        $.ajax({
                            url: "http://potichats.alwaysdata.net/search?t=" + type + "&o="+structure, success: function (res) {
                                try {
                                    data = JSON.parse(res);
                                    let taille = data.length;
                                    for (let index = 0; index < taille; index++) {
                                        let d = $("<p></p>").text(data[index].nom +" "+ data[index].prenom);
                                        $("#liens").append(d);
                                        d = $("<br>");
                                        $("#liens").append(d);
                                        d = $("<a></a>").text("https://sauveteurdudunkerquois.fr/" + data[index].link);
                                        $("#liens").append(d);
                                        d = $("<br>");
                                        $("#liens").append(d);
                                    }
            ...
            case "sortie":
                ...
                $(".add").click(function () {
                    ...
                    if ($("#texte-sortie-j").val() != null) {
                        tab = [$("#texte-sortie-j").val(), $("#texte-sortie-m").val(), $("#texte-sortie-a").val()];
                    }
                    else if ($("#texte-sortie-m").val() != null) {
                        tab = [null, $("#texte-sortie-m").val(), $("#texte-sortie-a").val()];
                    }
                    else {
